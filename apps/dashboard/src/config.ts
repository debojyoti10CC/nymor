...
export const config = {
  ...
  // per-buyer — see contracts/policy/README.md for the deploy record.
  ...
  // Real testnet transactions from apps/server/scripts/onchain-proof.mjs
  // — see contracts/policy/README.md's "Enforcement proof" section.
